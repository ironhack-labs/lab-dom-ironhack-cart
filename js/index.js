...
window.addEventListener('load', () => {
  ...
  //... your code goes here
  const removerProductoBtns = document.getElementsByClassName("btn-remove");
  for(let i = 0; i < removerProductoBtns.length; i++){
    removerProductoBtns[i].addEventListener("click", removeProduct)
    }
});
