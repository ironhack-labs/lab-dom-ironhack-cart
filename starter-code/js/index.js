...
function updateSubtot(product) {
  ...
  console.log(price); // comprobacion
...
function deleteItem (event) { //la funcion delete se ejecuta cuando clicas en un boton (un evento clic de boton tiene valores como el propio boton, cuando, duracion...)
...
function createItem () {
console.log("create") // comprobacion
...
console.log(newName) //comprobacion
...
//  function updateSubtot($product) {
//   let price= document.querySelectorAll('.product .pu');
//   console.log(price)
