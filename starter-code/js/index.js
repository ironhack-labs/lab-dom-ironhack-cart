// var realTotalPrice = document.getElementsById('spanTotal');
// console.log('total price div',realTotalPrice);

// var singleProfuctCost = document.getElementsByClassName('productCost')[0];
// console.log('single product price')

// var theQuantity = document.getElementsByClassName('qty')
// var theQuantity = document.getElementsByClassName
// var theQuantity = document.getElementsByClassName

// var theQuantity = document.getElementsByClassName

// calcPricesbtn.onclick = function(){
// var qty = theQuantity.value;
// var unitCost = singleProduct
